...
void grayscale(int height, int width, RGBTRIPLE image[height][width])
{
    ...
    for (int i = 0; i < width; i++)
    {
        ...
        {
            //I am going to calculate the average of colors
...
// Blur image (I had some problems with bluring I got help )
...
// we want to creat a temp table
    ...
    for (int i = 0; i < width; i++)
    {
        for (int j = 0; j < height; j++)
        {
            ...
            // sums values of the pixel and 8 neighbors
            //Pay attention to the outside of the pic we must skip them
            for (int k = -1; k < 2; k++)
            {
    ...
    //copy values from our temp table
    for (int i = 0; i < width; i++)
    {
        for (int j = 0; j < height; j++)
        {
